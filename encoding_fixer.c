...
// Преобразует строку из формата UTF8 в Windows 1251
int UTF8ToWin1251(const char* utf8, char* windows1251, size_t n)
{
	int i = 0;
	int j = 0;
...
/*
	char str[] = "Компания ООО АйТиПроект-программные решения\r\n";

	char cyr_str[sizeof(str)];
	UTF8ToWin1251(str, cyr_str, sizeof(str));
	printf("%s", cyr_str);
	getchar();
}
*/
